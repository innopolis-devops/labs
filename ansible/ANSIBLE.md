...
TASK [geerlingguy.docker : Install Python Package Manager] *************************************************************
ok: [InnoDevOps]

TASK [geerlingguy.docker : Install Docker SDK for Python] **************************************************************
ok: [InnoDevOps]

TASK [geerlingguy.docker : Install Docker Compose for Python] **********************************************************
ok: [InnoDevOps]
...
TASK [app_python : Wipe the Application Directory] *********************************************************************
skipping: [InnoDevOps]

TASK [app_python : Create a directory (if needed)] *********************************************************************
ok: [InnoDevOps]

TASK [app_python : Template the docker-compose.yml] ********************************************************************
--- before: /opt/app/docker-compose.yml
+++ after: /Users/igooor_bb/.ansible/tmp/ansible-local-54959u1uswm4/tmp5100g6h8/docker-compose.yml.j2
@@ -7,7 +7,7 @@
     expose:
       - 5000
   nginx:
-    build: igooorbb/inno-devops-nginx
+    image: igooorbb/inno-devops-nginx
     ports:
       - 1337:80
     depends_on:
...
TASK [app_python : Start the service] **********************************************************************************
changed: [InnoDevOps]

PLAY RECAP *************************************************************************************************************
InnoDevOps                 : ok=19   changed=3    unreachable=0    failed=0    skipped=15   rescued=0    ignored=0
```
