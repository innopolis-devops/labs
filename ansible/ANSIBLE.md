...
included: /home/ubuntu-1/DevOps-labs/ansible/roles/docker/tasks/docker-compose.yml for vm
...
+++ after: /home/ubuntu-1/.ansible/tmp/ansible-local-13785kv66ax7d/tmpotrw5ith/docker-compose.yml.j2
@@ -2,7 +2,7 @@
 
 services:
   python_app:
-    image: nailyav/lab2:image_tag
+    image: nailyav/lab2:latest
     volumes: 
    ...
    services:
      python_app:
        app_python_python_app_1:
          ...
          image: nailyav/lab2:latest
          labels:
            com.docker.compose.config-hash: 75c802a51e3d0582748285086a66f6fcfb9b4523ec39069fc874f24835bffd75
            com.docker.compose.container-number: '1'
            com.docker.compose.oneoff: 'False'
            com.docker.compose.project: app_python
            com.docker.compose.project.config_files: /opt/app_python/docker-compose.yml
            com.docker.compose.project.working_dir: /opt/app_python
            com.docker.compose.service: python_app
...
PLAY RECAP *********************************************************************
vm                         : ok=9    changed=2    unreachable=0    failed=0    skipped=12   rescued=0    ignored=0   
```
        ...
        "hostvars": {
            "vm": {
                "ansible_all_ipv4_addresses": [
                    {
                        "__ansible_unsafe": "192.168.10.32"
                    }
                ],
                "ansible_all_ipv6_addresses": [
                    {
                        "__ansible_unsafe": "fe80::d20d:1bff:fe9b:bef2"
                    }
                ],
                "ansible_apparmor": {
                    "status": {
                ...
                "ansible_board_serial": {
                    "__ansible_unsafe": "YC-fhmrjevf5jmuciv592u5"
                },
                ...
                "ansible_date_time": {
                    "date": {
                        "__ansible_unsafe": "2022-10-10"
                    },
                    "day": {
                        "__ansible_unsafe": "10"
                    },
                    "epoch": {
                        "__ansible_unsafe": "1665426161"
                    },
                    "epoch_int": {
                        "__ansible_unsafe": "1665426161"
                    },
                    ...
                    "iso8601": {
                        "__ansible_unsafe": "2022-10-10T18:22:41Z"
                    },
                    "iso8601_basic": {
                        "__ansible_unsafe": "20221010T182241786763"
                    },
                    "iso8601_basic_short": {
                        "__ansible_unsafe": "20221010T182241"
                    },
                    "iso8601_micro": {
                        "__ansible_unsafe": "2022-10-10T18:22:41.786763Z"
                    },
                    "minute": {
                        "__ansible_unsafe": "22"
                    },
                ...
                "ansible_default_ipv4": {
                    ...
                    "macaddress": {
                        "__ansible_unsafe": "d0:0d:1b:9b:be:f2"
                    },
                    "mtu": 1500,
                    "netmask": {
                ...
                "ansible_device_links": {
                    "ids": {
                        "vda": [
                            {
                                "__ansible_unsafe": "virtio-fhm7a62gc77f0v7pu7i0"
                            }
                        ],
                        "vda1": [
                            {
                                "__ansible_unsafe": "virtio-fhm7a62gc77f0v7pu7i0-part1"
                            }
                        ],
                        "vda2": [
                            {
                                "__ansible_unsafe": "virtio-fhm7a62gc77f0v7pu7i0-part2"
                            }
                        ]
                    },
                    "labels": {},
                ...
                "ansible_env": {
                    ...
                    "SUDO_COMMAND": {
                        "__ansible_unsafe": "/bin/sh -c echo BECOME-SUCCESS-wtvyvevdcilvdwfgjofdgdhbtgsnnqzh ; /usr/bin/python3"
                    },
                    "SUDO_GID": {
                ...
                "ansible_fqdn": {
                    "__ansible_unsafe": "fhmrjevf5jmuciv592u5.auto.internal"
                },
                "ansible_host": "10.0.2.15",
                "ansible_hostname": {
                    "__ansible_unsafe": "fhmrjevf5jmuciv592u5"
                },
                "ansible_hostnqn": {
                    "__ansible_unsafe": ""
                },
                ...
                "ansible_machine_id": {
                    "__ansible_unsafe": "23000007c6db9bbef2cede64be548bc5"
                },
                "ansible_memfree_mb": 347,
                "ansible_memory_mb": {
                    "nocache": {
                        "free": 1610,
                        "used": 365
                ...
                "ansible_product_uuid": {
                    "__ansible_unsafe": "23000007-c6db-9bbe-f2ce-de64be548bc5"
                },
