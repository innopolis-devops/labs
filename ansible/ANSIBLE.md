...
## Lab 5
 - `ansible-playbook playbooks/dev/main.yml --diff`:
    ...
    TASK [geerlingguy.docker : include_tasks] ***************************************************************************
    skipping: [51.250.81.82]

    TASK [geerlingguy.docker : include_tasks] ***************************************************************************
    included: /home/kali/.ansible/roles/geerlingguy.docker/tasks/setup-Debian.yml for 51.250.81.82
    ...
    TASK [geerlingguy.docker : include_tasks] ***************************************************************************
    included: /home/kali/.ansible/roles/geerlingguy.docker/tasks/docker-compose.yml for 51.250.81.82
            ...
            "hostvars": {
                "51.250.81.82": {
                    "ansible_all_ipv4_addresses": [
                        {
                            "__ansible_unsafe": "10.13.37.26"
                        }
                    ],
                    "ansible_all_ipv6_addresses": [
                        {
                            "__ansible_unsafe": "fe80::d20d:15ff:fe96:d945"
                        }
                    ],
                    "ansible_apparmor": {
                        "status": {
                    ...
                    "ansible_board_serial": {
                        "__ansible_unsafe": "YC-fhmlirckbo0oeimr4006"
                    },
                    ...
                    "ansible_date_time": {
                        ...
                        "iso8601": {
                            "__ansible_unsafe": "2022-10-03T22:42:02Z"
                        },
                        "iso8601_basic": {
                            "__ansible_unsafe": "20221003T224202088234"
                        },
                        "iso8601_basic_short": {
                            "__ansible_unsafe": "20221003T224202"
                        },
                        "iso8601_micro": {
                            "__ansible_unsafe": "2022-10-03T22:42:02.088234Z"
                        },
                        "minute": {
                            "__ansible_unsafe": "42"
                        },
                    ...
                    "ansible_default_ipv4": {
                        ...
                        "gateway": {
                            "__ansible_unsafe": "10.13.37.1"
                        },
                        "interface": {
                            "__ansible_unsafe": "eth0"
                        },
                        "macaddress": {
                            "__ansible_unsafe": "d0:0d:15:96:d9:45"
                        },
                        "mtu": 1500,
                        "netmask": {
                    ...
                    "ansible_device_links": {
                        "ids": {
                            "vda": [
                                {
                                    "__ansible_unsafe": "virtio-fhm51asrleghpum56drj"
                                }
                            ],
                            "vda1": [
                                {
                                    "__ansible_unsafe": "virtio-fhm51asrleghpum56drj-part1"
                                }
                            ],
                            "vda2": [
                                {
                                    "__ansible_unsafe": "virtio-fhm51asrleghpum56drj-part2"
                                }
                            ]
                        },
                        "labels": {},
                    ...
                    "ansible_env": {
                        ...
                        "SUDO_COMMAND": {
                            "__ansible_unsafe": "/bin/sh -c echo BECOME-SUCCESS-ecoelnxupizpdoumvjpmzerjhgsqoyzv ; /usr/bin/python3"
                        },
                        "SUDO_GID": {
                    ...
                    "ansible_fqdn": {
                        "__ansible_unsafe": "fhmlirckbo0oeimr4006.auto.internal"
                    },
                    "ansible_hostname": {
                        "__ansible_unsafe": "fhmlirckbo0oeimr4006"
                    },
                    "ansible_hostnqn": {
                        "__ansible_unsafe": ""
                    },
                    ...
                    "ansible_machine_id": {
                        "__ansible_unsafe": "23000007c6d596d945e01874adb20006"
                    },
                    "ansible_memfree_mb": 3240,
                    "ansible_memory_mb": {
                        "nocache": {
                            "free": 3688,
                            "used": 235
                    ...
                    "ansible_product_uuid": {
                        "__ansible_unsafe": "23000007-c6d5-96d9-45e0-1874adb20006"
                    },
                    ...
                    "ansible_ssh_host_key_dsa_public": {
                        "__ansible_unsafe": ""
                    },
                    "ansible_ssh_host_key_dsa_public_keytype": {
                        "__ansible_unsafe": "ssh-dss"
                    },
                    "ansible_ssh_host_key_ecdsa_public": {
                        "__ansible_unsafe": "AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBHoTz7sB6xePO7GG1Lt9K4NzGuaPDKOObao6THrKN0KQmx8uRNRo4r0dZJ0wAfVC0i6BtHRa8aOa1d+Db+7s/Sc="
                    },
                    "ansible_ssh_host_key_ecdsa_public_keytype": {
                        "__ansible_unsafe": "ecdsa-sha2-nistp256"
                    },
                    "ansible_ssh_host_key_ed25519_public": {
                        "__ansible_unsafe": "AAAAC3NzaC1lZDI1NTE5AAAAICkBsGj0q+h3MCBZX5kFf/0mzkMH4zFX9LeCr9BIdZ6H"
                    },
                    "ansible_ssh_host_key_ed25519_public_keytype": {
                        "__ansible_unsafe": "ssh-ed25519"
                    },
                    "ansible_ssh_host_key_rsa_public": {
                        "__ansible_unsafe": ""
                    },
