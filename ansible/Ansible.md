...
git 
```bash
$ ansible-playbook playbooks/web_app/main.yml --diff
PLAY [docker image] ************************************************************
...
TASK [docker : Ensure handlers are notified now to avoid firewall conflicts.] ***
TASK [docker : include_tasks] **************************************************
included: /home/ubuntu-1/DevOpsIU/ansible/roles/docker/tasks/docker-compose.yml forbakavm 
TASK [docker : Check current docker-compose version.] **************************
ok: [bakavm]
TASK [docker : set_fact] *******************************************************
ok: [bakavm]
...
+++ after: /home/ubuntu-1/.ansible/tmp/ansible-local-74839kv55ax7d/tmpotrw5ith/docker-compose.yml.j2
@@ -2,7 +2,7 @@
 
 services:
   python_app:
-    image: justmark0/devopsiu:image_tag
      ...
      python_app:
        app_python_python_app_1:
          ...
          state:
            ...
            status: running
PLAY RECAP *********************************************************************
bakavm                         : ok=9    changed=2    unreachable=0    failed=0    skipped=12   rescued=0    ignored=0   
```
