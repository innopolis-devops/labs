...
DOCUMENTATION = """
    ...
    options:
        ...
        yacloud_group_label:
            ...
            type: string
            default: ""
        yacloud_token_env_name:
            description: Name of env var with Oauth token for yacloud connection
            type: string
            default: ""
"""
...
class InventoryModule(BaseInventoryPlugin, Constructable, Cacheable):
    ...
    def _get_token(self):
        if self.get_option("yacloud_token_env_name"):
            import os

            return os.environ.get(self.get_option("yacloud_token_env_name"))
        else:
            return self.get_option("yacloud_token")
