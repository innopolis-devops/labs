![](https://github.com/markovvn1/devops-labs/actions/workflows/app_python.yml/badge.svg?branch=lab11)
...
2. Switch to lab11 branch and open project's directory:

   ```bash
   git checkout lab11 && cd app_python
   ```
