...
`geralizz@DESKTOP-QGAMLUK:~/labs_devops/app_python/ansible$ ansible-playbook -i inventory/default_yandex.yaml`
```
playbooks/dev/main.yaml --diff
...
TASK [docker : include_tasks] ***************************************************************************************************************************************************************************************************************
included: /home/geralizz/labs_devops/app_python/ansible/roles/docker/tasks/docker-python.yml for geralizzvm
...
PLAY RECAP **********************************************************************************************************************************************************************************************************************************
geralizzvm                 : ok=21   changed=2    unreachable=0    failed=0    skipped=13   rescued=0    ignored=0
```