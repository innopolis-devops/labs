...
```
PS E:\projects\temp\k8s> minikube service helm-app-python
|-----------|-----------------|-------------|--------------|
| NAMESPACE |      NAME       | TARGET PORT |     URL      |
|-----------|-----------------|-------------|--------------|
...
| NAMESPACE |      NAME       | TARGET PORT |          URL           |
|-----------|-----------------|-------------|------------------------|
| default   | helm-app-python |             | http://127.0.0.1:51272 |
|-----------|-----------------|-------------|------------------------|
...
```
PS C:\Users\Tiny Wizard\.kube> kubectl get pods,svc
NAME                                   READY   STATUS    RESTARTS   AGE
pod/helm-app-python-5654fbd547-kbktf   1/1     Running   0          5m13s

NAME                      TYPE        CLUSTER-IP      EXTERNAL-IP   PORT(S)   AGE
service/helm-app-python   ClusterIP   10.107.71.185   <none>        80/TCP    5m14s
```