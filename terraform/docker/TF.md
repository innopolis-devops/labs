...
## `terraform show`
```
romanmukhtarov@Air-Roman terraform % terraform show
...
resource "docker_image" "moscow_time" {
    id           = "sha256:69a656652bef13a03ae844763b7b8b96f12c72441fceaa9d96806847a64e57earomanza705/moscow_time:latest"
...
```
romanmukhtarov@Air-Roman terraform % terraform state list
docker_container.moscow_time
docker_image.moscow_time
...
## Changes
~~~
romanmukhtarov@Air-Roman terraform % terraform apply
docker_image.moscow_time: Refreshing state... [id=sha256:69a656652bef13a03ae844763b7b8b96f12c72441fceaa9d96806847a64e57earomanza705/moscow_time:latest]
docker_container.moscow_time: Refreshing state... [id=02d4ebf4dfbe15895e455e49e9a07945e1efff8c395f40c2688f8ea686e47019]
...
romanmukhtarov@Air-Roman terraform % terraform apply
docker_image.moscow_time: Refreshing state... [id=sha256:69a656652bef13a03ae844763b7b8b96f12c72441fceaa9d96806847a64e57earomanza705/moscow_time:latest]
docker_container.moscow_time: Refreshing state... [id=764d12189c53e271e5c6f114bbfa44b09953b017191443aa2883799f63014e8b]
...
-/+ resource "docker_container" "moscow_time" {
      ...
      - memory                                      = 0 -> null
      - memory_swap                                 = 0 -> null
      ~ name                                        = "tutorial" -> "moscow_time" # forces replacement
      ~ network_data                                = [
          - {
              - gateway                   = "172.17.0.1"
              - global_ipv6_address       = ""
...
image_id = "sha256:69a656652bef13a03ae844763b7b8b96f12c72441fceaa9d96806847a64e57earomanza705/moscow_time:latest"
