...
```
romanmukhtarov@Air-Roman yandex_cloud % terraform show
# yandex_compute_instance.default:
resource "yandex_compute_instance" "default" {
    allow_stopping_for_update = true
    created_at                = "2022-09-24T20:16:41Z"
...
resource "yandex_vpc_network" "foo" {
    created_at = "2022-09-24T20:16:36Z"
    folder_id  = "b1gvt2gqnaa14cpibnrp"
...
resource "yandex_vpc_subnet" "foo" {
    created_at     = "2022-09-24T20:16:38Z"
    folder_id      = "b1gvt2gqnaa14cpibnrp"
...
```
romanmukhtarov@Air-Roman yandex_cloud % terraform state list
yandex_compute_instance.default
yandex_vpc_network.foo
yandex_vpc_subnet.foo
```
...
```
romanmukhtarov@Air-Roman yandex_cloud % terraform apply
...
```
cores_number = 2
external_ip_address = "51.250.10.89"
memory_amount = 4
```